...
struct ContentView: View {
    ...
    @AppStorage("colourScheme", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var colourScheme: Int = 0
    @Environment(\.scenePhase) var scenePhase
    @AppStorage("showNotifications", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var showNotifications: Bool = false
    @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var notificationsEnabled: Bool = true

    @AppStorage("firstLaunch", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var firstLaunch: Bool = true

    // adds category orders
    @AppStorage("dataMigration1", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var dataMigration1: Bool = true

    // converts category colors to hex codes
    @AppStorage("dataMigration2", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var dataMigration2: Bool = true
    ...
    @AppStorage("topEdge", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var savedTopEdge: Double = 30
    @AppStorage("bottomEdge", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var savedBottomEdge: Double = 15

    // updateSheetShowing

    @AppStorage("previousVersion", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var previousVersionString: String = "Version \(UIApplication.appVersion ?? "") (\(UIApplication.buildNumber ?? ""))"

    @AppStorage("showUpdateSheet", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var showUpdateSheet: Bool = true
    ...
    var body: some View {
        ...
        .onAppear {
//            UserDefaults(suiteName: "group.com.vinbhaskara.dime")!.set(false, forKey: "newTransactionAdded")
//            WidgetCenter.shared.reloadTimelines(ofKind: "TemplateTransactions")
            ...
            let defaults =
                UserDefaults(suiteName: "group.com.vinbhaskara.dime") ?? UserDefaults.standard
