...
struct SettingsGoofyView: View {
  ...
  @AppStorage("confetti", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var confetti:
    Bool = false

  //    @AppStorage("chromatic", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime")) var chromatic: Bool = false

  @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime"))
  var lineGraph: Bool = false

  @AppStorage("budgetViewStyle", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime"))
  var budgetRows: Bool = false

  @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime"))
  var swapTimeLabel: Bool = false

  @AppStorage(
    "showTransactionRecommendations", store: UserDefaults(suiteName: "group.com.vinbhaskara.dime"))
